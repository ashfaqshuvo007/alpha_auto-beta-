                ...
                for ($i = 0; $i < $countfiles; $i++) {
                    ...
                    try {
                        if (in_array($ext, $valid_ext) && ($size <= 2000000)) {
                            ...
                            $stmt = $connection->prepare('INSERT INTO `images`(car_id,name,image) VALUES(:car_id,:name,:image)');
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="bannerImage">Car Images&nbsp;<i class="text-danger">* only jpg,jpeg,png files &
                                    size upto 2mb</i></label>
                            <input type="file" name="bannerImage" id="bannerImage" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="images">More Images&nbsp;<i class="text-danger">* only jpg,jpeg,png files & size
                                    upto 2mb</i></label>
